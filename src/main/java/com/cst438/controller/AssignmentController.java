...
public class AssignmentController {
    ...
    // when posting a new assignment,
    // should check that section is valid. If section is not found return error.
    ...
    public void updateGrades(@RequestBody List<GradeDTO> dlist) {
        // updateGrades logic is incorrect. The GradeDTO contains the primary id of the Grade entity.
        // Find the entity and update it. If not found, return an error. Should not create a new Grade entity.
        // Enrollment, Student Controllers are ok.
